...
EMPLOYEES = {
    "vstecs-admin": {"name": "Kevin Zhao", "role": "Solutions Architect", "dept": "Engineering", "tz": "America/Los_Angeles", "lang": "English",
    ...
    "vstecs-sa1": {"name": "Andy Liu", "role": "Solutions Architect", "dept": "Engineering", "tz": "America/New_York", "lang": "English",
    ...
    "vstecs-RDadmin": {"name": "Jason Xu", "role": "Software Engineer", "dept": "Backend Team", "tz": "America/Los_Angeles", "lang": "English",
        ...
        "daily": "Merged payment API feature branch. Code review for Tina's PR. Investigated latency spike in auth service."},
    "vstecs-sales1": {"name": "Henry Luo", "role": "Account Executive", "dept": "Enterprise Sales", "tz": "America/New_York", "lang": "English",
    ...
    "vstecs-fin1": {"name": "Stella Zhu", "role": "Finance Analyst", "dept": "Finance", "tz": "America/Los_Angeles", "lang": "English",
    ...
    "vstecs-pm1": {"name": "Diana Wen", "role": "Product Manager", "dept": "Product", "tz": "America/New_York", "lang": "English",
    ...
    "vstecs-csm1": {"name": "Cathy Bai", "role": "Customer Success Manager", "dept": "Customer Success", "tz": "America/New_York", "lang": "English",
    ...
    "vstecs-legal1": {"name": "Wendy Shen", "role": "Legal Counsel", "dept": "Legal & Compliance", "tz": "America/New_York", "lang": "English",
    ...
    "vstecs-exec1": {"name": "Patrick Tan", "role": "Executive", "dept": "Engineering", "tz": "America/New_York", "lang": "English",

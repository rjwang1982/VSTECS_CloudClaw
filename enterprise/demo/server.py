...
DEPARTMENTS = [
    {"id":"dept-eng",         "name":"Engineering",          "parentId":"",         "headName":"Patrick Tan",  "headId":"vstecs-exec1",  "employeeCount":9},
    {"id":"dept-eng-backend", "name":"Backend Team",         "parentId":"dept-eng", "headName":"Jason Xu",     "headId":"vstecs-RDadmin","employeeCount":2},
    {"id":"dept-eng-frontend","name":"Frontend Team",        "parentId":"dept-eng", "headName":"Victor Qian",  "headId":"vstecs-dev2",   "employeeCount":1},
    {"id":"dept-eng-platform","name":"Platform Team",        "parentId":"dept-eng", "headName":"Leo Zhang",    "headId":"vstecs-ITadmin","employeeCount":2},
    {"id":"dept-eng-qa",      "name":"QA Team",              "parentId":"dept-eng", "headName":"Frank Jiang",  "headId":"vstecs-qa1",    "employeeCount":1},
    {"id":"dept-sales",       "name":"Sales",                "parentId":"",         "headName":"Henry Luo",    "headId":"vstecs-sales1", "employeeCount":3},
    {"id":"dept-sales-ent",   "name":"Enterprise Sales",     "parentId":"dept-sales","headName":"Henry Luo",   "headId":"vstecs-sales1", "employeeCount":2},
    {"id":"dept-sales-smb",   "name":"SMB Sales",            "parentId":"dept-sales","headName":"Oscar Ye",    "headId":"vstecs-sales3", "employeeCount":1},
    {"id":"dept-product",     "name":"Product",              "parentId":"",         "headName":"Diana Wen",    "headId":"vstecs-pm1",    "employeeCount":2},
    {"id":"dept-finance",     "name":"Finance",              "parentId":"",         "headName":"Stella Zhu",   "headId":"vstecs-fin1",   "employeeCount":2},
    {"id":"dept-hr",          "name":"HR & Admin",           "parentId":"",         "headName":"Megan Xie",    "headId":"vstecs-hr1",    "employeeCount":1},
    {"id":"dept-cs",          "name":"Customer Success",     "parentId":"",         "headName":"Cathy Bai",    "headId":"vstecs-csm1",   "employeeCount":1},
    {"id":"dept-legal",       "name":"Legal & Compliance",   "parentId":"",         "headName":"Wendy Shen",   "headId":"vstecs-legal1", "employeeCount":1},
]

_EMP_DATA = [
    # Engineering
    ("vstecs-admin",   "Kevin Zhao",    "EMP-001", "pos-sa",    "Solutions Architect",         "dept-eng",          "Engineering",       "admin",   47),
    ("vstecs-sa1",     "Andy Liu",      "EMP-002", "pos-sa",    "Solutions Architect",         "dept-eng",          "Engineering",       "employee",42),
    ("vstecs-sa2",     "Brian Feng",    "EMP-003", "pos-sa",    "Solutions Architect",         "dept-eng",          "Engineering",       "employee",28),
    ("vstecs-RDadmin", "Jason Xu",      "EMP-004", "pos-sde",   "Software Engineer",           "dept-eng-backend",  "Backend Team",      "employee",62),
    ("vstecs-dev1",    "Tina Huang",    "EMP-005", "pos-sde",   "Software Engineer",           "dept-eng-backend",  "Backend Team",      "employee",38),
    ("vstecs-dev2",    "Victor Qian",   "EMP-006", "pos-sde",   "Software Engineer",           "dept-eng-frontend", "Frontend Team",     "employee",15),
    ("vstecs-ITadmin", "Leo Zhang",     "EMP-007", "pos-devops","DevOps Engineer",             "dept-eng-platform", "Platform Team",     "admin",   72),
    ("vstecs-devops1", "Grace Ding",    "EMP-008", "pos-devops","DevOps Engineer",             "dept-eng-platform", "Platform Team",     "employee",19),
    ("vstecs-qa1",     "Frank Jiang",   "EMP-009", "pos-qa",    "QA Engineer",                 "dept-eng-qa",       "QA Team",           "employee",24),
    # Sales
    ("vstecs-sales1",  "Henry Luo",     "EMP-011", "pos-ae",    "Account Executive",           "dept-sales-ent",    "Enterprise Sales",  "manager", 35),
    ("vstecs-sales2",  "Ivy Sun",       "EMP-012", "pos-ae",    "Account Executive",           "dept-sales-ent",    "Enterprise Sales",  "employee",22),
    ("vstecs-sales3",  "Oscar Ye",      "EMP-013", "pos-ae",    "Account Executive",           "dept-sales-smb",    "SMB Sales",         "employee",12),
    # Product
    ("vstecs-pm1",     "Diana Wen",     "EMP-015", "pos-pm",    "Product Manager",             "dept-product",      "Product",           "manager", 44),
    ("vstecs-pm2",     "Nina Gao",      "EMP-014", "pos-pm",    "Product Manager",             "dept-product",      "Product",           "employee",12),
    # Finance
    ("vstecs-fin1",    "Stella Zhu",    "EMP-016", "pos-fa",    "Finance Analyst",             "dept-finance",      "Finance",           "employee",33),
    ("vstecs-fin2",    "Ray Cheng",     "EMP-017", "pos-fa",    "Finance Analyst",             "dept-finance",      "Finance",           "employee",18),
    # HR, CS, Legal
    ("vstecs-hr1",     "Megan Xie",     "EMP-018", "pos-hr",    "HR Specialist",               "dept-hr",           "HR & Admin",        "manager", 29),
    ("vstecs-csm1",    "Cathy Bai",     "EMP-019", "pos-csm",   "Customer Success Manager",    "dept-cs",           "Customer Success",  "employee",41),
    ("vstecs-legal1",  "Wendy Shen",    "EMP-021", "pos-legal", "Legal Counsel",               "dept-legal",        "Legal & Compliance","employee",15),
    # Executive
    ("vstecs-exec1",   "Patrick Tan",   "EMP-031", "pos-exec",  "Executive",                   "dept-eng",          "Engineering",       "employee",28),
]
...
SESSIONS = [
    {"id":"sess-001","agentId":"agent-sa-admin",      "agentName":"SA Agent - Kevin",      "employeeId":"vstecs-admin",   "employeeName":"Kevin Zhao",    "channel":"discord",  "turns":12,"tokensUsed":24500,"status":"active","lastActive":"2026-03-22T10:30:00Z","lastMessage":"Analyzing microservice architecture for TechCorp..."},
    {"id":"sess-002","agentId":"agent-sde-RDadmin",   "agentName":"SDE Agent - Jason",     "employeeId":"vstecs-RDadmin", "employeeName":"Jason Xu",      "channel":"slack",    "turns":8, "tokensUsed":16200,"status":"active","lastActive":"2026-03-22T10:25:00Z","lastMessage":"Running git diff on feature/payment-api branch..."},
    {"id":"sess-003","agentId":"agent-fa-fin1",       "agentName":"Finance Agent - Stella","employeeId":"vstecs-fin1",    "employeeName":"Stella Zhu",    "channel":"telegram", "turns":5, "tokensUsed":10100,"status":"active","lastActive":"2026-03-22T10:20:00Z","lastMessage":"Generating Q2 budget variance report..."},
    {"id":"sess-004","agentId":"agent-ae-sales1",     "agentName":"Sales Agent - Henry",   "employeeId":"vstecs-sales1",  "employeeName":"Henry Luo",     "channel":"whatsapp", "turns":3, "tokensUsed":6100, "status":"active","lastActive":"2026-03-22T10:15:00Z","lastMessage":"Querying CRM for TechCorp pipeline data..."},
    {"id":"sess-005","agentId":"agent-helpdesk",      "agentName":"IT Help Desk Agent",    "employeeId":"vstecs-dev2",    "employeeName":"Victor Qian",   "channel":"slack",    "turns":2, "tokensUsed":4100, "status":"active","lastActive":"2026-03-22T10:10:00Z","lastMessage":"Resetting VPN credentials for new laptop..."},
    {"id":"sess-006","agentId":"agent-devops-ITadmin","agentName":"DevOps Agent - Leo",    "employeeId":"vstecs-ITadmin", "employeeName":"Leo Zhang",     "channel":"telegram", "turns":15,"tokensUsed":30500,"status":"active","lastActive":"2026-03-22T09:45:00Z","lastMessage":"Checking CloudWatch alarms for prod ECS cluster..."},
    {"id":"sess-007","agentId":"agent-pm-pm1",        "agentName":"PM Agent - Diana",      "employeeId":"vstecs-pm1",     "employeeName":"Diana Wen",     "channel":"slack",    "turns":6, "tokensUsed":12200,"status":"idle", "lastActive":"2026-03-22T09:00:00Z","lastMessage":"Updating sprint 12 backlog in Jira..."},
    {"id":"sess-008","agentId":"agent-csm-csm1",      "agentName":"CSM Agent - Cathy",     "employeeId":"vstecs-csm1",    "employeeName":"Cathy Bai",     "channel":"slack",    "turns":4, "tokensUsed":8100, "status":"idle", "lastActive":"2026-03-22T08:30:00Z","lastMessage":"Preparing TechCorp QBR deck for Friday..."},
]

AUDIT_ENTRIES = [
    {"id":"aud-001","timestamp":"2026-03-22T10:30:00Z","eventType":"agent_invocation","actorId":"vstecs-admin","actorName":"Kevin Zhao","targetType":"agent","targetId":"agent-sa-admin","detail":"Discord: Analyze microservice architecture for TechCorp migration","status":"success"},
    {"id":"aud-002","timestamp":"2026-03-22T10:25:00Z","eventType":"agent_invocation","actorId":"vstecs-RDadmin","actorName":"Jason Xu","targetType":"agent","targetId":"agent-sde-RDadmin","detail":"Slack: Run git diff on feature/payment-api branch","status":"success"},
    {"id":"aud-003","timestamp":"2026-03-22T10:20:00Z","eventType":"permission_denied","actorId":"vstecs-dev2","actorName":"Victor Qian","targetType":"tool","targetId":"shell","detail":"SDE attempted shell access on idle session — blocked by Plan A","status":"blocked"},
    {"id":"aud-004","timestamp":"2026-03-22T10:15:00Z","eventType":"config_change","actorId":"system","actorName":"Auto-Provision","targetType":"binding","targetId":"agent-sde-dev1","detail":"Auto-provisioned SDE Agent for Tina Huang","status":"success"},
    {"id":"aud-005","timestamp":"2026-03-22T09:45:00Z","eventType":"agent_invocation","actorId":"vstecs-fin1","actorName":"Stella Zhu","targetType":"agent","targetId":"agent-fa-fin1","detail":"Telegram: Generate Q2 budget variance report for Engineering","status":"success"},
    {"id":"aud-006","timestamp":"2026-03-22T09:30:00Z","eventType":"permission_denied","actorId":"vstecs-fin1","actorName":"Stella Zhu","targetType":"tool","targetId":"shell","detail":"Finance role attempted shell — blocked by Position SOUL","status":"blocked"},
    {"id":"aud-007","timestamp":"2026-03-22T09:00:00Z","eventType":"config_change","actorId":"vstecs-admin","actorName":"Kevin Zhao","targetType":"soul","targetId":"pos-sa","detail":"Updated SA Position SOUL template v1→v2","status":"success"},
    {"id":"aud-008","timestamp":"2026-03-22T08:30:00Z","eventType":"approval","actorId":"vstecs-admin","actorName":"Kevin Zhao","targetType":"approval","targetId":"apr-003","detail":"Approved github-pr access for Jason Xu (SDE)","status":"success"},
]

APPROVALS = [
    {"id":"apr-001","tenant":"Victor Qian","tenantId":"vstecs-dev2","tool":"shell","reason":"Need to run diagnostic commands for local dev environment","risk":"medium","timestamp":"2026-03-22T08:00:00Z","status":"pending"},
    {"id":"apr-002","tenant":"Grace Ding","tenantId":"vstecs-devops1","tool":"code_execution","reason":"Testing Python script for Terraform automation","risk":"low","timestamp":"2026-03-22T07:30:00Z","status":"pending"},
    {"id":"apr-003","tenant":"Jason Xu","tenantId":"vstecs-RDadmin","tool":"github-pr","reason":"Need to create PR for payment API feature","risk":"low","timestamp":"2026-03-21T14:00:00Z","status":"approved","reviewer":"Kevin Zhao","resolvedAt":"2026-03-21T15:00:00Z"},
    {"id":"apr-004","tenant":"Stella Zhu","tenantId":"vstecs-fin1","tool":"shell","reason":"Want to check server logs for budget discrepancy","risk":"high","timestamp":"2026-03-20T10:00:00Z","status":"denied","reviewer":"Kevin Zhao","resolvedAt":"2026-03-20T11:00:00Z"},
]

AUDIT_INSIGHTS = {"insights":[
    {"id":"ins-001","severity":"high","category":"access_pattern","title":"Repeated shell access attempts from SDE (idle session)","description":"2 blocked shell access attempts from SDE-role employees in 24h.","recommendation":"Consider sandboxed shell skill for offline SDE sessions.","affectedUsers":["Victor Qian","Grace Ding"],"detectedAt":"2026-03-22T10:35:00Z","source":"audit_log_scan"},
    {"id":"ins-002","severity":"medium","category":"data_exposure","title":"Finance Agent sharing cost data via public Slack channel","description":"Q2 budget variance shared in #general instead of #finance-private.","recommendation":"Add channel restriction rule for financial data.","affectedUsers":["Stella Zhu"],"detectedAt":"2026-03-22T10:25:00Z","source":"memory_scan"},
    {"id":"ins-003","severity":"high","category":"compliance","title":"SOUL template drift — 2 SA agents on old version","description":"Position SOUL updated 2 days ago but 2 agents not reassembled.","recommendation":"Trigger workspace reassembly for affected agents.","affectedUsers":["Andy Liu","Brian Feng"],"detectedAt":"2026-03-22T07:00:00Z","source":"version_drift_check"},
    {"id":"ins-004","severity":"medium","category":"memory_risk","title":"PII detected in 2 employee memory files","description":"Phone numbers found in MEMORY.md files.","recommendation":"Enable automatic PII redaction for memory writes.","affectedUsers":["Henry Luo","Cathy Bai"],"detectedAt":"2026-03-22T08:30:00Z","source":"memory_scan"},
    {"id":"ins-005","severity":"low","category":"behavior_anomaly","title":"Unusual after-hours usage from DevOps Agent","description":"72 messages this week, 40% between 11PM-3AM.","recommendation":"Review session logs, add after-hours alerts.","affectedUsers":["Leo Zhang"],"detectedAt":"2026-03-22T09:00:00Z","source":"usage_pattern_analysis"},
...
def handle_api(method, path, body=None):
    ...
    if p == "auth/me":
        return 200, {"id":"vstecs-admin","name":"Kevin Zhao","role":"admin","departmentId":"dept-eng","departmentName":"Engineering","positionId":"pos-sa","positionName":"Solutions Architect"}
    ...
    # Portal
    if p == "portal/chat" and method == "POST": return 200, {"response":"[Demo Mode] I'm your AI assistant at VSTECS Corp. In production, this message would be processed by a real Bedrock model inside a Firecracker microVM with your personalized SOUL identity.","agentId":"agent-fa-fin1","agentName":"Finance Agent - Stella Zhu","source":"demo"}
    if p == "portal/profile": return 200, {"employee":EMPLOYEES[14],"agent":AGENTS[14],"userMd":"# Stella's Preferences\n\n- Prefer EBITDA over net income\n- YoY comparison always\n- USD format: $X,XXX.XX","memoryMdSize":2400,"dailyMemoryCount":5}
...
if __name__ == "__main__":
    ...
    print(f"   Login: any employee ID (e.g. vstecs-admin, vstecs-fin1)")
